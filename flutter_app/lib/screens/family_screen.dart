...
class FamilyScreen extends StatefulWidget {
  ...
  final Future<bool> Function(FamilyMember member) onMemberAdded;
...
class _FamilyScreenState extends State<FamilyScreen> {
  ...
  Future<void> _addMember() async {
    ...
    final added = await widget.onMemberAdded(member);
    if (!added) return;
    if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(18),
        border: Border.all(
            color: const Color(0xFFD5DAE1), style: BorderStyle.solid),
      ),
      child: Column(
        children: [
          ...
          const Text('Connect to an elderly user’s device via ID',
          ...
          if (showValidation) ...[
            ...
            const Align(
              ...
              child: Text('Please enter both Elderly User ID and Nickname.',
                  style: TextStyle(
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: const TextStyle(
                color: Color(0xFFB8BEC8), fontWeight: FontWeight.w700),
            filled: true,
            ...
            enabledBorder: OutlineInputBorder(
              ...
              borderSide:
                  const BorderSide(color: Color(0xFF8E97A3), width: 1.4),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(6),
              borderSide:
                  const BorderSide(color: Color(0xFF0B63C9), width: 1.6),
            ),
