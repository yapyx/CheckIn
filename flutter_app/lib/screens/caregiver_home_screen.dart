...
class CaregiverHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenFrame(
      ...
      bottomNavigationBar:
          CaregiverNav(onHome: () {}, onFamily: onFamily, activeFamily: false),
      child: Column(
        children: [
          DashboardHeader(
                  ...
                  ...messages.map(
                    (message) => Padding(
                      ...
                      child: DashboardMessageCard(
                        ...
                        onDismiss: message.actionLabel == null
                            ? null
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Caregiver profile preferences will appear here.',
                  style: TextStyle(
                      fontSize: 16, color: Color(0xFF6B7280), height: 1.35)),
      ...
      child: InkWell(
        ...
        child: Ink(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border: message.tone == MessageTone.plain
                ? Border.all(color: const Color(0xFFC9D1DD))
                : null,
            boxShadow: const [
              BoxShadow(
                  color: Color(0x08000000), blurRadius: 8, offset: Offset(0, 2))
            ...
            child: IntrinsicHeight(
              child: Row(
                children: [
                  Container(
                      width: 4,
                      color: message.tone == MessageTone.plain
                          ? Colors.transparent
                          : message.accentColor),
                  Expanded(
                    child: Padding(
                          ...
                          Row(
                            ...
                            children: [
                              const CircleAvatar(
                                radius: 16,
                                backgroundImage:
                                    AssetImage('assets/senior pfp.png'),
                              ),
                              ...
                              child: OutlinedButton(
                                ...
                                style: OutlinedButton.styleFrom(
                                  ...
                                  side: const BorderSide(
                                      color: Color(0xFF0B1F33), width: 1.6),
...
class _EmptyMessages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Text(
          'No recent messages. New care updates will appear here.',
          style:
              TextStyle(fontSize: 17, color: Color(0xFF6B7280), height: 1.35)),
    );
  }
}
